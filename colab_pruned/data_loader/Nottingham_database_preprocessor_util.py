...
def rectify_stream_part(stream_part,DURATION_EPS = 0.000001):
    ...
    #DEBUGGING
    rest_to_append = note.Rest('')
    rest_to_append.duration = duration.Duration(6)
    stream_part.append(rest_to_append)
    #DEBUGGING
    for i in range(L):
...
def get_melody(symbol_list,time_list,is_duration=False,DURATION_EPS = 0.001):
...
#lib: from music21 import *
def get_melody_aligned_with_chord(melody_duration_list,chord_symbol_list,chord_time_list,DURATION_EPS = 0.001):
    time_stamp = 0
